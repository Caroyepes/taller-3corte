...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2025 a las 02:50:59
...
CREATE TABLE `producto` (
  ...
  `valor_unit` decimal(20,2) NOT NULL,
...
(1, 'milo', 999.99, 'comida', 'REF-001', '2025-11-24'),
(2, 'chocolisto', 999.99, 'comida', 'REF-002', '2025-11-24'),
(3, 'Aceite', 999.99, 'comida', 'REF-003', '2025-11-25'),
(4, 'Mieltertos', 999.99, 'Medicamentos', 'REF-7001', '2025-11-25'),
(5, 's', 278.00, 'a', 'ss', '2025-11-25'),
(6, 't', 314.00, 'k', '875', '2025-11-25'),
(7, 'fifo', 15424128.00, 'reto', '21587', '2025-11-25');
...
(1, 'nestle', '1234', 'nestle@gmail.com', 2147483647, '2025-11-24'),
(2, 'colombina', '1234', 'colombina@gmail.com', 2147483647, '2025-11-24'),
(3, 'Saceites', 'Km 2 via giron', 'saceites@gmail.com', 2147483647, '2025-11-25'),
(4, 'Tecnoquimicas', 'Bogota avda 30', 'tecno@gmail.com', 2147483647, '2025-11-25'),
(5, 'a', 'a', 'a', 2, '2025-11-25'),
(6, 'h', 'p', 'c@g.com', 5, '2025-11-25'),
(7, 'azucar', 'melo', 'eee', 2147483647, '2025-11-25');
